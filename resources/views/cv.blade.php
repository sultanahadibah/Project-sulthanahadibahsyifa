...
<body id="page-top">
    ...
    ======================================================-->      
      <section class="resume-section p-3 p-lg-5 " id="experience">
          <div class="row my-auto">
              <div class="col-12">
                <h2 class="  text-center">Experience Sulthanah Adibah S.S</h2>
                <div class="mb-5 heading-border"></div>
              </div>
              <div class="resume-item col-md-6 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-globe mr-3 text-info"></i>  Web Developer</h4>
                      <p>Hai, saya berpengalaman dalam merancang sebuah website dan mengembangkan sebuah website yang dan mengimplementasikan web tersebut tentunya yang berguna di masa depan</p>
                  </div>
              ...
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #ffc107; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-laptop mr-3 text-warning"></i>  Point Of Sale</h4>
                      <p>Berpengalam dalam mebuat penjualan menggunakan sistem enterprise yang di dukung oleh aplikasi oddo serta berpengalam dalam men distributorkan sale menggunakan module di dalama aplikasi odoo.</p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">Juli 2021 - Desember 2023</span>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #28a745; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-camera mr-3 text-success"></i> Sistem Informasi</h4>
                      <p>Saya berpengalaman dalam merancang sistem Informasi, mampu merancang sistem informasi sesuai dengan kebutuhan masyarakat maupun kebutuhan yang diminta oleh klien.</p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">July 2020 - December 2022</span>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #2196f3; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      ...
                      <p>Berpengalaman dalam mendesign web yang di minta oleh perusahaan tempat magang saya saat inii.</p>
                  </div>
                  <div class="resume-date text-md-right">
    ...
    ======================================================-->      
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="portfolio"> 
          <div class="row my-auto">
              <div class="col-12">
                <h2 class="  text-center">Portfolio Sulthanah Adibah S.</h2>
                <div class="mb-5 heading-border"></div>
              </div>
              <div class="col-md-12">
                <div class="port-head-cont">
                  ...
                  <button class="btn btn-general btn-green filter-b" data-filter="marketing">Point Of Sale</button> 
                </div>
              </div>
          </div>
          <div class="row my-auto">
    ...
    ======================================================-->       
      <section class=" d-flex flex-column" id="skills">
         <div class="p-lg-5 p-3 skill-cover">
          <h3 class="text-center text-white">Coding Skills this web design </h3>
              ...
              <div class="main-award" id="award-box">
                  <div class="award">
                      ...
                      <div class="award-content">
                          <span class="date">maret 2020 - april 2021</span>
                          <h5 class="title">VGSA Certified Developer</h5>
                          <p class="description">
                          Mengikuti seminar dalam me design web sehingga mapu berkolaborasi dalan web design di dunia teknologi.
                          </p>
                      </div>
                  </div>
                  <div class="award">
                      <div class="award-icon"></div>
                      <div class="award-content">
                          <span class="date">Juli 2022- Desember 2022</span>
                          <h5 class="title">AI exam python certificate</h5>
                          <p class="description">
                              Mengerjakan project seputar phyton untuk menguasi kualifikasi dari ujian untuk semesster akhir yang bertujuan untuk mengasah kemapuan di bidang AI.
                          </p>
                      </div>
                  </div>
              </div>
              ...
              <div class="container">
                  <div class="row">
                          <div class="modal-body">
                              <div class="title-bar">
                                <div class="col-md-12">
                                  <h2 class="text-center">Our Project Team Sulthanah Adibah Syifa</h2>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <p>Hai kami baru memulai project, kami adalah tim dari bagian web desgin yang khususnya menerima permintaan klien di bidang web selain itu kami juga memilki tim di divisi mobile apps, dan enterprise system jangan lupa jika anda berminat mari mulai bekrja sama dalam memajukan dunia teknologi di bidang apapun agar memudahkan masyarakat dalam mengelola dunia kalau tidak skerang kapan lagi .</p>
